 ...
 */
   ...
   */
  #define DETAILED_BUILD_VERSION SHORT_BUILD_VERSION " (Github, rdelcorro)"
   ...
   * version was tagged.
   */
  #define STRING_DISTRIBUTION_DATE "2019-09-23"
   ...
   * Marlin repository.
   */
  #define SOURCE_CODE_URL "https://github.com/rdelcorro/Marlin-Ai3M"
